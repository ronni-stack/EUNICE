"""EUNICE v0.9 — Intent Classification
Replaces blunt keyword matching with structured intent detection.
"""
import re
...
class IntentClassifier:
    ...
    TOOL_KEYWORDS = {
        "get_balance": ["balance", "account", "how much money", "bank"],
        "network_scan": ["scan network", "network scan", "who is on my wifi", "devices on network"],
        "notes": ["take a note", "save note", "write down", "remember this"],
